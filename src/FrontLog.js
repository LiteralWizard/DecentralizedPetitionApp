...
class FrontLog extends Component {
    Copyright() {
        return (
                ...
                <div style = {{
                    ...
                    <div className={classes.paper}>
                        ...
                        <TextField
                            ...
                            id="accountName"
                        />
                        <AwesomeButton style = {{width: "20vw"}} type = "primary">Sign In</AwesomeButton>
                        </form>
                    </div>
                    <Box mt={8}>
                        <Link style = {{paddingBottom: "100px"}} onClick={(event) => {
                            event.preventDefault()

                            this.props.callbackAcc("Redirect Code: -1")
                        }} variant="body2">
